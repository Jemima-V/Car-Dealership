...
public class Dodge extends Vehicle implements BrandDetails{
  ...
  String proceed;
  String addOnType [] = {"1. Paint and Fabric Protection", "2. Nitrogen Filled Tires","3. Black Tire Rims"};
  double addOnCost [] = {150, 300, 250};
  String serviceType [] = {"1. Car Detailing", "2. Break Pad Replacement"};
  double serviceCost [] = {350, 60};
  ...
  public Dodge(int y, String t, String m, String co, double pr, String cu, String ph, String a){
  ...
  public void vehicleSpecifications (){
    ...
    System.out.println("\n--- DODGE ORDER SPECIFICATIONS ---");
    System.out.println("\n~~FUN FACT: " + BrandDetails.sellingFact + " ~~");
    System.out.println("\nHere your sales associate will enter all the nesscessary information for you to purchase your dream Dodge!!");
    ...
    System.out.print("\nEnter type of Dodge Vehicle (i.e SUV, Convertable ect.): ");
    super.setType(input.next());
    System.out.print("\nEnter model of Dodge Vehicle (i.e Durango, Charger ect): ");
    super.setModel(input.next());
    System.out.print("\nEnter colour of Dodge Vehicle: ");
    ...
    if(proceed.equalsIgnoreCase("y")){
        System.out.println("\n\n**ORDER APPROVED**\nYour order has been sent to our main system, your will be able to pick up your new Dodge in the next few days!");
  ...
  public void vehicleAddOns(){
    ...
    do{
      System.out.println("\n--- Dodge Vehicle Add Ons ---\n");
      for (int x=0;x<addOnType.length;x++){
        System.out.println(addOnType[x]);
      }
      System.out.print("\nWhich Add On would you like to add to your Dodge? (#): ");
  ...
  public void autoShopServices(){
    ...
    do{
      ...
      System.out.println("\n--- Dodge Autoshop Services ---");
      System.out.println("\n~~FUN FACT: " + BrandDetails.serviceFact + " ~~");
      System.out.println("Here your sales associate will help you select service(s) for your Dodge!!\n");
      for (int x=0;x<serviceType.length;x++){
        System.out.println(serviceType[x]);
      }
      System.out.print("\nWhich auto-repair service would you like done on your Dodge? (#): ");
